    ...
    return(
      ...
      >
        ...
        <Row className=" d-flex justify-content-between align-items-center">
                ...
                <Col className="text-center">
                 <p>
                   {props.pokemon && props.pokemon.types.map((type)=>{
                     return(
                      <Button variant="outline-dark m-2" key={type.type.name}>{type.type.name}</Button>
                     )
                   })}
            ...
            <p><b>Hp:</b> <ProgressBar variant="success" now={props.pokemon && props.pokemon.stats[0].base_stat}/> 
            </p>
